local strings = {
	...
	SI_PBSCHATASSISTANT_TABSTRIP_X = "タブ表示: 横位置",
	SI_PBSCHATASSISTANT_TABSTRIP_Y = "タブ表示: 縦位置",
	SI_PBSCHATASSISTANT_TABSTRIP_POS_TOOLTIP = "タブ表示の位置です。横位置は画面中央から、縦位置は画面上端からの距離です。",
